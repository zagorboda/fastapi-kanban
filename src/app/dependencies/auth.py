...
async def get_user_from_token(
    *,
    ...
    try:
        ...
        raise e
    return user_scheme.User(**user.to_dict())


def get_current_active_user(current_user: user_scheme.User = Depends(get_user_from_token)) -> Optional[user_scheme.User]:
    if not current_user:
        raise HTTPException(
